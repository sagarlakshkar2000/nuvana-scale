                ...
                <div class="container-fluid">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="footer-link-block">
                                    ...
                                    <form method="post" class="newsletter-form">
                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="21" height="21"
                                            viewBox="0 0 21 21" fill="none">
                                            <path
                    ...
                    <div class="py-32">
                        <div class="footer-bottom-bar">
                            <p class="white">@2026 All Rights Copyright <a href="#" class="color-primary"> PowerUp</a>.
                                Design & Developed By <span class="color-primary">
                                    UIPARADOX</span></p>
