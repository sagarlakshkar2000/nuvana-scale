        ...
        <div class="col-12">
          ...
          <ul class="nav nav-pills mb-4 bg-white p-2 rounded-3 shadow-sm" id="productTabs" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active px-4 fw-semibold" id="general-tab" data-bs-toggle="pill"
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link px-4 fw-semibold" id="media-tab" data-bs-toggle="pill" data-bs-target="#media"
                type="button" role="tab" aria-controls="media" aria-selected="false">
                <i class="fas fa-image me-2"></i>Media
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link px-4 fw-semibold" id="specifications-tab" data-bs-toggle="pill"
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link px-4 fw-semibold" id="marketing-tab" data-bs-toggle="pill"
                data-bs-target="#marketing" type="button" role="tab" aria-controls="marketing" aria-selected="false">
                ...
                <div class="card-body px-4 pb-4">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control form-control-lg @error('sku') is-invalid @enderror"
                        name="sku" value="{{ old('sku') }}" placeholder="Auto-generated">
                      @error('sku')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                        rows="5" placeholder="Write a detailed product description...">{{ old('description') }}</textarea>
                      @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="predefined_specs[{{ $specKey }}]"
                              value="{{ old('predefined_specs.' . $specKey, $specValue) }}"
                    ...
                    @if(old('features'))
                      @foreach(old('features') as $index => $feature)
                        <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                          <button type="button" class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 removeRowBtn"
                            style="z-index: 10;">
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" name="features[{{ $index }}][icon]"
                                value="{{ $feature['icon'] ?? '' }}" placeholder="e.g. ⭐, 🎯">
                            </div>
                            <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" name="features[{{ $index }}][title]"
                                value="{{ $feature['title'] ?? '' }}" placeholder="e.g. High Quality">
                            </div>
                            <div class="col-12">
                              ...
                              <textarea class="form-control" name="features[{{ $index }}][description]" rows="2"
                                placeholder="Detailed description...">{{ $feature['description'] ?? '' }}</textarea>
                            </div>
                          </div>
                        </div>
                      @endforeach
                      ...
                      @foreach(old('ideal_for') as $index => $ideal)
                        <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              <label class="form-label small fw-semibold text-muted mb-1">Icon or Emoji</label>
                              <input type="text" class="form-control" name="ideal_for[{{ $index }}][icon]"
                                value="{{ $ideal['icon'] ?? '' }}" placeholder="e.g. ⭐, 🎯">
                            </div>
                            <div class="col-md-6">
                              <label class="form-label small fw-semibold text-muted mb-1">Target Name</label>
                              <input type="text" class="form-control" name="ideal_for[{{ $index }}][title]"
                                value="{{ $ideal['title'] ?? '' }}" placeholder="e.g. Retail Shops">
                            </div>
                            <div class="col-12">
                              <label class="form-label small fw-semibold text-muted mb-1">Description</label>
                              <textarea class="form-control" name="ideal_for[{{ $index }}][description]" rows="2"
                                placeholder="Detailed description...">{{ $ideal['description'] ?? '' }}</textarea>
                            </div>
                          </div>
                        </div>
                      @endforeach
                    @else
                      <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            <label class="form-label small fw-semibold text-muted mb-1">Target Name</label>
                            <input type="text" class="form-control" name="ideal_for[0][title]"
                              placeholder="e.g. Retail Shops">
                          </div>
                          <div class="col-12">
                            <label class="form-label small fw-semibold text-muted mb-1">Description</label>
                            <textarea class="form-control" name="ideal_for[0][description]" rows="2"
                              placeholder="Detailed description..."></textarea>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                          ...
                          <div class="row g-3">
                            <div class="col-12">
                              ...
                              <input type="text" class="form-control" name="why_choose_nuvana[{{ $index }}][title]"
                                value="{{ $reason['title'] ?? '' }}" placeholder="e.g. Premium Quality">
                            </div>
                            <div class="col-12">
                              <label class="form-label small fw-semibold text-muted mb-1">Description</label>
                              <textarea class="form-control" name="why_choose_nuvana[{{ $index }}][description]" rows="2"
                                placeholder="Why should they choose Nuvana?">{{ $reason['description'] ?? '' }}</textarea>
                            </div>
                          </div>
                        </div>
                      @endforeach
                    @else
                      <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            <label class="form-label small fw-semibold text-muted mb-1">Reason Title</label>
                            <input type="text" class="form-control" name="why_choose_nuvana[0][title]"
                              placeholder="e.g. Premium Quality">
                          </div>
                          <div class="col-12">
                            <label class="form-label small fw-semibold text-muted mb-1">Description</label>
                            <textarea class="form-control" name="why_choose_nuvana[0][description]" rows="2"
                              placeholder="Why should they choose Nuvana?"></textarea>
                          </div>
                        </div>
                      </div>
                    @endif
                        ...
                        <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                          ...
                          <div class="row g-3">
                            <div class="col-12">
                              ...
                              <textarea class="form-control" name="faqs[{{ $index }}][question]" rows="2"
                                placeholder="Type the question here...">{{ $faq['question'] ?? '' }}</textarea>
                            </div>
                            <div class="col-12">
                              <label class="form-label small fw-semibold text-muted mb-1">Answer</label>
                              <textarea class="form-control" name="faqs[{{ $index }}][answer]" rows="2"
                                placeholder="Type the answer here...">{{ $faq['answer'] ?? '' }}</textarea>
                            </div>
                          </div>
                        </div>
                      @endforeach
                    @else
                      <div class="dynamic-item p-3 border rounded mb-3 position-relative bg-light">
                        ...
                        <div class="row g-3">
                          <div class="col-12">
                            <label class="form-label small fw-semibold text-muted mb-1">Question</label>
                            <textarea class="form-control" name="faqs[0][question]" rows="2"
                              placeholder="Type the question here..."></textarea>
                          </div>
                          <div class="col-12">
                            <label class="form-label small fw-semibold text-muted mb-1">Answer</label>
                            <textarea class="form-control" name="faqs[0][answer]" rows="2"
